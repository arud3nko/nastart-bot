...
class DB:
    ...
    async def select(self, table_name: str, *args: Any) -> list:
    ...
    async def delete(self, table_name: str, where_cond: Any, where_value: Any) -> bool:
        """
    ...
    async def update(self, table_name: str, where_cond: Any, where_value: Any, **kwargs):
        """
